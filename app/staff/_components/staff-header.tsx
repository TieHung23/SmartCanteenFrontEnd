...
export function StaffHeader({ onMenuClick }: { onMenuClick?: () => void }) {
  ...
  return (
    <header className="h-18 border-b border-gray-200 bg-white flex items-center justify-between px-4 md:px-8 shrink-0">
      <div className="flex items-center gap-3 flex-1 max-w-2xl">
        {onMenuClick && (
          <button
            onClick={onMenuClick}
            className="lg:hidden p-2 -ml-2 text-gray-500 hover:text-gray-800 focus:outline-none shrink-0"
