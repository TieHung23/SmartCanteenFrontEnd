...
export default function ManagerDashboard() {
  const kpis = [
    { title: "Total Orders", value: "25.1k", color: "text-blue-600", icon: Receipt, bg: "bg-blue-50" },
    { title: "Total Profit", value: "$2,435k", color: "text-emerald-600", icon: DollarSign, bg: "bg-emerald-50" },
    { title: "Claims Received", value: "3.5M", color: "text-rose-600", icon: BarChart3, bg: "bg-rose-50" },
    { title: "New Customers", value: "43.5k", color: "text-orange-600", icon: Users, bg: "bg-orange-50" },
  ];
  ...
  return (
    <div className="space-y-8 animate-fade-in">
        ...
        {kpis.map((item, i) => (
          ...
          >
            <div className="space-y-1">
              <p className="text-xs font-black text-gray-400 uppercase tracking-wider">{item.title}</p>
      ...
      <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:border-gray-200 transition-colors">
        <h3 className="text-2xl font-black text-gray-900 mb-6">Sales Reports Overview</h3>
