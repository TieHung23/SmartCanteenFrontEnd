...
export default function MenuPage() {
  ...
  // 1. GỌI API (Luôn gọi hooks ở cấp trên cùng)
  ...
  // Chuẩn bị mảng cho Marquee (Thanh cuộn ngang vô tận)
  const navItems = [
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#FDFBF9] pb-24 font-sans overflow-x-hidden">
        {/* ── HEADER KIỂU MỚI: MINIMALIST & MODERN (ENGLISH) ── */}
        ...
        {/* --- THANH TOP NAV: MARQUEE TỰ ĐỘNG CHẠY --- */}
        ...
        {/* --- HIỂN THỊ MÓN ĂN: NỚI RỘNG GẦN HẾT MÀN HÌNH --- */}
