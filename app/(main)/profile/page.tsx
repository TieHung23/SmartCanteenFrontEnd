...
const cardThemes = [
  {
    ...
    background: "bg-gradient-to-br from-orange-400 via-amber-400 to-yellow-300",
  ...
  },
  {
    id: "blue",
    name: "Royal Sapphire",
    background: "bg-gradient-to-br from-indigo-500 via-blue-400 to-sky-300",
    shadow: "shadow-blue-400/25",
  },
  {
    id: "emerald",
    name: "Emerald Wealth",
    background: "bg-gradient-to-br from-emerald-500 via-teal-400 to-cyan-300",
    shadow: "shadow-teal-400/25",
  },
  {
    id: "purple",
    name: "Cyberpunk Neon",
    background: "bg-gradient-to-br from-purple-500 via-pink-400 to-rose-300",
    shadow: "shadow-pink-400/25",
  },
  {
    id: "rosegold",
    name: "Rose Gold Prestige",
    background: "bg-gradient-to-br from-rose-400 via-pink-300 to-amber-200",
    shadow: "shadow-rose-300/25",
  },
  {
    id: "aurora",
    name: "Cosmic Aurora",
    background: "bg-gradient-to-br from-violet-500 via-indigo-400 to-fuchsia-300",
    shadow: "shadow-violet-400/25",
  },
  {
    id: "gold",
    name: "Gold Sovereign",
    background: "bg-gradient-to-br from-amber-400 via-yellow-300 to-amber-200",
    shadow: "shadow-amber-400/25",
  },
  {
    id: "ocean",
    name: "Ocean Deep",
    background: "bg-gradient-to-br from-cyan-500 via-blue-400 to-teal-300",
    shadow: "shadow-cyan-400/25",
  },
  {
    id: "lava",
    name: "Crimson Lava",
    background: "bg-gradient-to-br from-rose-500 via-red-400 to-orange-300",
    shadow: "shadow-red-400/25",
  },
  {
    id: "platinum",
    name: "Platinum Silver",
    background: "bg-gradient-to-br from-slate-400 via-zinc-300 to-gray-200",
    shadow: "shadow-slate-300/25",
  },
  {
    id: "nordic",
    name: "Nordic Forest",
    background: "bg-gradient-to-br from-emerald-600 via-teal-500 to-green-300",
